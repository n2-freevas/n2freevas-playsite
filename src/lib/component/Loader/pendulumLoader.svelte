...
<div class='loader' style='--loader-height: {`${initial_length + (increase_length * numof_pendulum) + initial_size}px`};'>
    <div class='fulcrum'>
        ...
        <!-- Pendulum Part -->
            <div class='wire {is_animate? "animate" : ""}' style='--wire_length_px: {args.wire_length}; --periodic_time_sec: {args.periodic_time}; --color: {color};'>
                <div class='weight' style='--weight_size_px: {args.weight_size};'></div>
            </div>
        {/each}
