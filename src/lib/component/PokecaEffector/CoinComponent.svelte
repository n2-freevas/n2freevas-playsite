...
<div class="coin {flip ? 'flip' : ''} {openFrontFlip ? 'openFrontFlip' : ''} {openBackFlip ? 'openBackFlip' : ''}" on:click={coinToss}>
    <div class="front">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 284 284"
            ><g fill="none" fill-rule="evenodd"
                ><circle fill="#000" cx="142" cy="142" r="142" /><circle fill="#F2EE9D" cx="142.5" cy="142.5" r="131.5" /><path
                    ...
                    ><circle fill="#000" cx="27.5" cy="27.5" r="27.5" /><circle fill="#FFF" cx="27.7" cy="27.3" r="10.5" /></g
                ><g transform="translate(175 106)"><circle fill="#000" cx="27.5" cy="27.5" r="27.5" /><circle fill="#FFF" cx="27.7" cy="27.3" r="10.5" /></g
                ><circle fill="#E9ACB5" cx="49" cy="174" r="24" /><circle fill="#E9ACB5" cx="233" cy="180" r="24" /><ellipse
                    fill="#000"
                    cx="142.5"
                    cy="170.5"
                    rx="7.5"
    ...
    <div class="back">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 284 284"
            ><g fill="none" fill-rule="evenodd"
                ><circle fill="#000" cx="142" cy="142" r="142" /><circle fill="#805593" cx="142.5" cy="142.5" r="131.5" /><path
                    ...
                    fill="#6B6B6B" /><circle fill="#E9ACB5" cx="49" cy="174" r="24" /><circle fill="#E9ACB5" cx="233" cy="174" r="24" /><ellipse
                    fill="#000"
                    cx="142.5"
                    cy="170.5"
                    rx="7.5"
