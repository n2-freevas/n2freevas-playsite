<script lang="ts">
    ...
    import type { SynegierCard, SynegierTextColor, SynegierTextType } from '$lib/model/app/SynegierAdmin'
        ...
        <div class="costSummary">
            {#each costSummary as count, i}
                <div class="costSummaryItem">
                    ...
                    <div class="countBar" style="--width: {count < 11 ? count*20 : 200}px"></div>
            ...
            .stColorSummary{
                ...
                .stColorItem{
                    ...
                    .stSubjectBar, .stVerbusBar{
                        ...
                        &.blue{&::before{background: #0085FF;}}
                        &.green{&::before{background: #00c036;}}
                        &.yellow{&::before{background: #ffc700;}}
                        &.red{&::before{background: #e40000;}}
                        &.purple{&::before{background: #c600e6;}}
                    }
                    .stSubjectBar{
                        border-left: solid 2px white;
                        &::before{right:0;}
